...
namespace Tracker.TelegramBot.Services
{
    public class StatisticsService
    {
        ...
        internal async Task<List<DBTask>> getGivenPeriodTasks(DateTime startPeriod, DateTime endPeriod)
        {
            List<DBTask> tasks = await mongoDBTaskService.GetAll();
        ...
        internal async Task<Dictionary<DateTime, int>> getUserStatistics(DBUser user, DateTime startPeriod, DateTime endPeriod)
        {
            ...
            List<DBTask> tasks = await getGivenPeriodTasks(startPeriod, endPeriod);

...
<img src="./Diagrams/4C - BotService" width="700" title="4C - BotService">
...
<img src="./Diagrams/4C - StatisticsService" width="700" title="4C - StatisticsService">
### TrackerRepository
Репозиторий предназначен для работы с базой данных (реализация операций CRUD).
<img src="./Diagrams/4C - TrackerRepository" width="700" title="4C - TrackerRepository">
...
<img src="./Diagrams/SequenceDiagram - личная статистика" width="700" title="SequenceDiagram - личная статистика">
### Просмотр подробной статистики по сотрудникам компании
<img src="./Diagrams/SequenceDiagram - статистика по компании" width="700" title="SequenceDiagram - статистика по компании">
...
<img src="./Diagrams/ClassDiagram - Database" width="700" title="ClassDiagram - Database">
